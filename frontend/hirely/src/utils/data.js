...
export const jobSeekerFeatures = [
  {
    ...
    description:
    "AI-powerd algorith matches you with relavent opportunities based on your skills and preferences."
  },
  {
    icon: FileText,
...
export const employerFeatures = [
  ...
  },
  {
    ...
    description:
    "Track your hiring preformance with detailed analytics and insights on candidate engagement"
  },
  {
    icon: Shield,
