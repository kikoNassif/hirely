...
const LogIn = () => {
  ...
  if (formState.success) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-gra-50 px-4">
        <motion.div 
    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4">
      ...
      >
        <div className="text-center mb-8">
          <h2 className="text-2xl font-bold text-gray-900 mb-2">Welcome Back</h2>
          <p className="">Sign in to your Hirely account</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            ...
            <div className="relative">
              ...
              className={`w-full pl-10 pr-4 py-3 rounded-lg border ${ formState.errors.email ? 'border-red-500' : 'border-gray-300'} focus:ring-blue-500 focus:border-transparent transition-colors`}
