...
const SignUp = () => {
  ...
  const validateForm = () => {
    const errors = {
      ...
      avatar: "", // optional, validated separately
    };
        ...
        <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4">
          ...
          >
            ...
            <p className="text-gray-600 mb-4">
              Welcome to Hirely! Your account has been successfully created.
            </p>
           ...
           <div>
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="flex-1">
                ...
                <label  
                  htmlFor="avatar"
                  className="cursor-pointer b-gray-50 border border-gray-300 rounded-lg px-4 py-2 text-sm font-medium text-gray-700 hover:bg-gray-100 transition-colors flex items-center space-x-2"
                >
