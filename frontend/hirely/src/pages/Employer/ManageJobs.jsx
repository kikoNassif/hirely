...
const ManageJobs = () => {
  ...
  const handleDeleteJob = async (jobId) => {
    try {
      ...
      console.error("Error delecting job:", error)
    }
  };
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl shadow-black/5 border border-white/20 p-6 mb-8">
                      ...
                      {isLoading
                        ...
                        : paginatedJobs.map((job) => (
                          ...
                          >
                            ...
                            <td className="px-6 py-5 whitespace-nowrap min-w-[130px] sm:mi-w-0">
                              <button
                                className="flex items-center text-sm text-blue-600 hover:text-blue-800 font-semibold transition-colors duration-200 hover:bg-blue-500 px-2 py-1 rounded-lg"
                                onClick={() => 
                                  navigate("/applicants", {
                                    state: { jobId: job.id },
                                  })
            ...
            {totalPages > 1 && (
              <div className="mt-6 flex items-center justify-between">
                <div className="flex-1 flex justify justify-between sm:hidden">
                  <button
