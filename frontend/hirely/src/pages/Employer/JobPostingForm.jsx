    ...
    const fetchJobDetails = async () => {
      if (jobId) {
        try {
          ...
          console.log("Error fetching nob details");
          if (error.response) {
                ...
                <div className="grid grid-cols-3 gap-3">
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-10 pr-3 py-2.5 border border-gray-300 rounded-lg text-base focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-20 focus:border-blue-500 duration-200"
                    />
                  </div>
                  <div className="relative">
                    <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none z-10">
