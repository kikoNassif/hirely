  ...
  return (
    <div className="flex h-screen bg-gray-50">
      ...
      >
        ...
        <div className="flex items-center h-16 border-b border-gray-200 pl-6">
          {!sidebarCollapsed ? (
            ...
            <div className="h-8 w-8 bg-gradient-to-br from-blue-600 to-blue-700 rounded-xl flex items-center jusitfy-center">
      ...
      {isMobile && sidebarOpen && (
        <div
          className="fixed inset-0 bg-black bg-opacity-25 z-40 backgrop-blur-sm"
