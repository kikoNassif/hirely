        ...
        <div className="flex items-center space-x-3">
          ...
          {isAuthenticated ? (
            ...
            <>
              ...
              <a
                href="/signup"
                className="bg-gradient-to-r from-blue-600 to-purple-600 px-6 py-2 rounded-lg font-medium hover:from-blue-700 hover:to-purple-700 transition-all duration-300 shadow-sm hover:shadow-md"
              >
                Sign Up
              </a>
            </>
